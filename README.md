...
**[hello rails react]** is a project for using react as a frontend app for rails api(backend)
...
```
  First copy this repo and clone it on your machine using this [link](git@github.com:Ibnballo1/hello-react-front-end.git).
  Then cd into hello-react-front-end folder.
  npm install
  or
  yarn install
  bundle install
...
This project is [MIT](https://github.com/Ibnballo1/hello-react-front-end/blob/frontend/MIT.md) licensed.
